  ...
  try {
    ...
    const htmlContent = `<!DOCTYPE html>
      ...
      <head>
        ...
        <style>
          :root {--plyr-color-main: rgb(0, 112, 112);}
          body {font-family: 'Inter', sans-serif;}
          button.plyr__control--overlaid {display:none; visibility: hidden;}
        </style>
      </head>
      <body>
        <video controls crossorigin playsinline id="player">${sourcesHTML}${tracksHTML}</video>
